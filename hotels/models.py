...
class Room(models.Model):
    ...
    room_policy_section_1 = models.TextField(default="Modified_Room policy Section 1 (Nourhan)",blank=True)
    room_policy_section_2 = models.TextField(default="Modified_Room policy Section 2 (Nourhan)",blank=True)
    room_policy_section_3 = models.TextField(default="Modified_Room policy Section 3 (Nourhan)",blank=True)
    room_policy_section_4 = models.TextField(default="Modified_Room policy Section 4 (Nourhan)",blank=True)
    room_policy_section_5 = models.TextField(default="Modified_Room policy Section 5 (Nourhan)",blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
